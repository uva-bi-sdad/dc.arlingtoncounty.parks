...
Ex: dc_environment_land_use.va013_tr_arlopendata_2021_parks_catchment_scores: get_parks_data.R
dc_environment_land_use.va013_bg_arlopendata_2021_parks_catchment_scores: get_parks_data.R


```{r data}

# Ex database_table_name: "va_hd_vdoe_2019_2021_3rd_grade_mean_median_read_score"
table_names = c("va013_tr_arlopendata_2021_parks_catchment_scores", "va013_bg_arlopendata_2021_parks_catchment_scores") 
    
con <- get_db_conn()

dat_file_name <- table_names[1]
db_schema_name <- "dc_environment_land_use"  # Ex database schema_name: dc_education_training
...
all_geos_file_name <- "va013_trbg_arlopendata_2021_parks_catchment_scores"  #Ex: "va_vdoe_2019_2021_3rd_grade_mean_median_read_score"
